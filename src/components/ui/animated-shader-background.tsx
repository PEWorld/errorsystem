...
const AnoAI = () => {
  ...
  useEffect(() => {
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          for (float i = 0.0; i < 20.0; i++) {
            ...
            float tailNoise =
              fbm(v + vec2(iTime * 0.5, i)) * 0.3 * (1.0 - (i / 20.0));
    ...
    const handleResize = () => {
      const nw = Math.floor(window.innerWidth * RENDER_SCALE)
      const nh = Math.floor(window.innerHeight * RENDER_SCALE)
  ...
  return <div ref={containerRef} className="absolute inset-0 overflow-x-hidden" />
}
